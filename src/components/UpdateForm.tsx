    ...
    return (
        ...
        <form action={handleUpdatePost} className='space-y-4'>
            ...
            <div>
                ...
                <input type="text" id="title" name="title" defaultValue={postProps.post.title} required className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" />
            </div>
