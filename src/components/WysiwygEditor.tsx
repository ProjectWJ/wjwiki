    ...
    <div className="w-full max-w-[1008px] mx-auto border border-black/10 rounded-xl shadow-[0_4px_64px_0_rgba(0,152,186,0.15)] overflow-hidden bg-white">
      ...
      <div className="hidden lg:flex items-center justify-between px-6 py-3 border-b border-border">
        <div className="flex items-center gap-6">
          <button className="text-sm text-foreground hover:bg-accent px-2 py-1 rounded">
            File
          </button>
          <button className="text-sm text-foreground hover:bg-accent px-2 py-1 rounded">
            Edit
      ...
      <div className="hidden lg:flex items-center gap-2 px-6 py-3 border-b border-border flex-wrap">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem
              onClick={() => setParagraphType("Paragraph text")}
            >
              Paragraph text
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setParagraphType("Heading 1")}>
              Heading 1
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setParagraphType("Heading 2")}>
              Heading 2
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setParagraphType("Heading 3")}>
              Heading 3
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        {/* Font Size */}
        <button className="px-3 py-1.5 hover:bg-accent rounded text-sm">
          −
        </button>
